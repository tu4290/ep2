...
DEFAULT_FETCHER_CONFIG_PATH: str = "config.json" # Corrected path
...
def _load_config_from_file(config_path: str) -> Dict:
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__)) # .../elite_options_system/services
    parent_dir = os.path.dirname(script_dir) # .../elite_options_system

    if os.path.isabs(config_path):
        absolute_config_path = config_path
    else:
        absolute_config_path = os.path.join(parent_dir, config_path) # .../elite_options_system/config.json
...
if __name__ == "__main__":
    ...
    TEST_CONFIG_PATH_MAIN = DEFAULT_FETCHER_CONFIG_PATH # Uses corrected path
