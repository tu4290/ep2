...
try:
    from elite_options_system.dashboard.utils import get_config_value, create_empty_figure
    from elite_options_system.dashboard.styling import APP_THEME
    utils_styling_available = True
    print("LAYOUT.PY: Successfully imported from elite_options_system.dashboard.utils and elite_options_system.dashboard.styling.")
except ImportError as e:
    print(f"LAYOUT.PY WARNING: Failed to import from elite_options_system.dashboard.utils or elite_options_system.dashboard.styling: {e}. Using fallback functions/theme.")
...
ENHANCED_BLURBS = {
    ...
    <p>Hover over each bar for precise values. Click items in the legend to filter score categories. Colors, score thresholds, and opacity settings are configurable in <code>config.json</code> under <code>elite_score_chart_config</code>.</p>
    </div>""",
