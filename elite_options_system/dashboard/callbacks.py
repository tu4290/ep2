...
try:
    from elite_options_system.dashboard.styling import PLOTLY_TEMPLATE_DARK as imported_plotly_template_styling_cb
    PLOTLY_TEMPLATE_DARK_CB = imported_plotly_template_styling_cb
    from elite_options_system.dashboard.utils import (
    ...
    logger.critical(f"CALLBACKS.PY CRITICAL: Failed to import from elite_options_system.dashboard.styling or elite_options_system.dashboard.utils: {_utils_import_err_final_cb}. Using fallbacks for these functions.", exc_info=True)
...
try:
    from elite_options_system.dashboard.layout import (
    ...
    logger.info("CALLBACKS.PY: Successfully imported CHART_IDS, Component IDs, and Mode Layout functions from elite_options_system.dashboard.layout.")
except ImportError as e_layout_ids_import_cb_final:
    logger.error(f"CALLBACKS.PY: Failed to import from elite_options_system.dashboard.layout: {e_layout_ids_import_cb_final}. Using fallback IDs/functions.", exc_info=True)
    _layout_ids_imported_successfully_cb = False
